/*
 ...
 Spośród zwierząt obecnych na łące tylko owce można strzyc. Proszę dopisać niezbędne metody tak, by poniższy program działał poprawnie.

 Uwaga: Plik Animal.h jest udostępniony na UPeLu. Nie należy go modyfikować.
 */
